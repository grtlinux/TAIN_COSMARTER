...
public final class Exec {
	...
	private final static String KEY_EXEC_CHARSET = "tain.cosmarter.v03.exec.charset";
	private static String charSet;
	static {
		try {
			Exec.charSet = Param.getInstance().getString(KEY_EXEC_CHARSET, "NO_VALUE");
			if (flag) System.out.printf(">>>>> [%s] = [%s]\n", KEY_EXEC_CHARSET, Exec.charSet);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
